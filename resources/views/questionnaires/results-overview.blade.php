...
@section('content')
    ...
    <p class="small text-muted mb-4">
        Показват се всички завършили опити за тази анкета. Новите опити записват кой потребител ги е направил; стари опити без акаунт се отбелязват като „Анонимен“.
    </p>
